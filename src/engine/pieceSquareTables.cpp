...
S pawn_pst[64] = {S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(53, 118), S(87, 109), S(60, 112), S(83, 57), S(69, 53), S(57, 69), S(-7, 116), S(-41, 126), S(-18, 51), S(1, 62), S(32, 27), S(33, 3), S(40, -6), S(64, -15), S(47, 31), S(-1, 23), S(-30, -25), S(-2, -33), S(0, -51), S(3, -63), S(23, -71), S(15, -64), S(19, -48), S(-7, -51), S(-39, -52), S(-10, -52), S(-6, -70), S(7, -76), S(10, -77), S(6, -73), S(6, -62), S(-18, -73), S(-36, -60), S(-13, -54), S(-8, -69), S(-3, -62), S(11, -67), S(4, -68), S(24, -65), S(-9, -78), S(-34, -57), S(-10, -51), S(-15, -61), S(-11, -54), S(0, -51), S(16, -64), S(34, -67), S(-17, -77), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0)};
S knight_pst[64] = {S(-127, -76), S(-111, -10), S(-46, 4), S(-11, -5), S(25, -1), S(-33, -27), S(-84, -8), S(-81, -97), S(-5, -19), S(16, 2), S(42, 10), S(60, 9), S(41, 2), S(103, -13), S(17, -3), S(40, -38), S(14, -2), S(51, 13), S(70, 30), S(78, 31), S(116, 14), S(121, 8), S(78, 0), S(49, -16), S(14, 9), S(30, 28), S(55, 40), S(78, 42), S(58, 42), S(83, 38), S(44, 27), S(53, -1), S(2, 8), S(19, 18), S(40, 42), S(43, 41), S(53, 45), S(47, 34), S(41, 19), S(15, 0), S(-15, -7), S(10, 12), S(28, 19), S(38, 35), S(51, 33), S(37, 15), S(32, 7), S(3, -6), S(-22, -17), S(-11, -1), S(7, 10), S(27, 10), S(25, 10), S(27, 5), S(6, -10), S(3, -7), S(-74, -23), S(-3, -26), S(-15, -8), S(0, -4), S(3, -1), S(9, -12), S(-2, -19), S(-41, -34)};
S bishop_pst[64] = {S(-22, 7), S(-56, 15), S(-51, 9), S(-94, 21), S(-70, 15), S(-57, 4), S(-31, 3), S(-51, 2), S(-21, -5), S(-9, -4), S(-17, -1), S(-32, 0), S(-3, -10), S(-10, -8), S(-8, 0), S(-7, -7), S(-9, 15), S(5, 1), S(1, 0), S(15, -10), S(4, -5), S(43, -3), S(28, -2), S(26, 9), S(-12, 8), S(-8, 7), S(2, 0), S(13, 11), S(9, 1), S(5, 4), S(-4, 2), S(-10, 8), S(-10, 3), S(-15, 7), S(-15, 7), S(6, 4), S(3, 4), S(-13, 2), S(-16, 4), S(2, -6), S(-2, 6), S(-3, 3), S(-4, 2), S(-6, 2), S(-4, 6), S(-2, 1), S(0, -3), S(12, -2), S(10, 8), S(4, -5), S(7, -14), S(-10, 0), S(-2, -1), S(8, -8), S(21, 0), S(9, -8), S(0, -2), S(15, 5), S(5, -2), S(-8, 1), S(-1, 0), S(-4, 9), S(15, -10), S(12, -14)};
S rook_pst[64] = {S(15, 24), S(-3, 32), S(-5, 41), S(-4, 36), S(13, 28), S(37, 20), S(37, 18), S(56, 15), S(-7, 25), S(-12, 37), S(3, 41), S(22, 30), S(9, 30), S(38, 18), S(38, 12), S(71, -1), S(-23, 25), S(0, 26), S(-9, 27), S(-10, 25), S(20, 11), S(34, 4), S(84, -4), S(60, -8), S(-27, 26), S(-17, 22), S(-23, 31), S(-21, 25), S(-16, 11), S(2, 4), S(14, 3), S(16, 0), S(-38, 17), S(-42, 20), S(-34, 21), S(-30, 18), S(-27, 14), S(-26, 11), S(-4, 0), S(-13, -2), S(-40, 12), S(-40, 11), S(-32, 9), S(-30, 10), S(-22, 5), S(-15, -3), S(14, -20), S(-5, -18), S(-38, 5), S(-35, 9), S(-20, 8), S(-21, 8), S(-15, 0), S(-6, -6), S(5, -13), S(-21, -6), S(-16, 8), S(-16, 9), S(-11, 15), S(-5, 8), S(0, 2), S(0, 4), S(9, -2), S(-11, -5)};
S queen_pst[64] = {S(-10, 34), S(-35, 63), S(-17, 83), S(15, 66), S(20, 65), S(23, 66), S(70, 5), S(23, 41), S(-7, 29), S(-32, 55), S(-31, 89), S(-41, 109), S(-35, 127), S(1, 85), S(-4, 68), S(47, 61), S(-4, 32), S(-13, 40), S(-18, 71), S(-9, 80), S(0, 92), S(45, 73), S(58, 40), S(61, 45), S(-20, 39), S(-18, 46), S(-20, 56), S(-22, 73), S(-22, 89), S(-6, 81), S(3, 76), S(11, 69), S(-14, 32), S(-23, 52), S(-21, 49), S(-15, 64), S(-15, 61), S(-13, 59), S(-5, 56), S(4, 56), S(-13, 22), S(-10, 29), S(-12, 39), S(-12, 33), S(-9, 37), S(-4, 39), S(6, 27), S(5, 26), S(-3, 13), S(-7, 13), S(1, 6), S(5, 11), S(2, 17), S(12, -9), S(18, -31), S(35, -46), S(-7, 13), S(-5, 8), S(2, 5), S(8, 19), S(6, 1), S(-9, 7), S(15, -16), S(10, -15)};
S king_pst[64] = {S(68, -109), S(48, -55), S(82, -44), S(-73, 7), S(-23, -9), S(32, -8), S(79, -19), S(127, -120), S(-69, -7), S(-18, 22), S(-57, 34), S(51, 16), S(-5, 38), S(0, 49), S(27, 41), S(3, 7), S(-88, 8), S(26, 28), S(-45, 48), S(-63, 58), S(-24, 58), S(50, 51), S(25, 49), S(-15, 19), S(-53, -2), S(-67, 33), S(-84, 53), S(-127, 65), S(-121, 66), S(-83, 59), S(-82, 50), S(-111, 24), S(-53, -14), S(-60, 18), S(-92, 43), S(-125, 59), S(-126, 58), S(-86, 44), S(-91, 32), S(-118, 15), S(-12, -25), S(5, 0), S(-52, 22), S(-67, 35), S(-63, 35), S(-59, 26), S(-15, 6), S(-33, -7), S(76, -46), S(34, -17), S(20, -4), S(-14, 6), S(-17, 10), S(1, 0), S(48, -19), S(56, -37), S(63, -82), S(95, -63), S(71, -43), S(-22, -24), S(39, -45), S(2, -27), S(76, -56), S(73, -84)};
